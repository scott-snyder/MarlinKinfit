...
// these are now defined upstream    
...
//    
    ...
    /// get track i
    virtual TrackParticleFitObject *getTrack (int i
					      ) const {return tracks[i].track;}
        
    /// add track
    virtual void addTrack (TrackParticleFitObject *track,   ///< The track
...
//    mutable bool covinvvalid; 
    ...
    struct TrackDescriptor {
      TrackParticleFitObject *track;
      bool inbound;
      bool measured;
      TrackDescriptor (TrackParticleFitObject *track_, bool inbound_, bool measured_)
